...
");
		...
		");
			...
			/// TSQL 格式： SELECT * FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {where}
			/// </summary>
			...
			/// TSQL 格式： SELECT * FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp}
			/// </summary>
			...
			/// <summary>
			/// 返回一个表的 top 行数据（传入 TSQL WHERE 部分的表达式对象）并填充传入DataTable，返回受影响行数
			/// TSQL 格式： SELECT * FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp}
			/// </summary>
...
");
		...
		");
			...
			/// TSQL 格式： SELECT TOP 1 * FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {where}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			...
			/// <summary>
			/// 根据传入的 TSQL WHERE 表达式对象，查找返回一行数据。未找到则返回 null
			/// TSQL 格式： SELECT TOP 1 * FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
...
");
		...
		");
			...
			/// TSQL 格式： SELECT TOP 1 __cols..... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {where}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			...
			/// TSQL 格式： SELECT TOP 1 __cols..... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp, params DI." + tn + @"[] __cols}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
...
");
			...
			/// <summary>
			/// 返回一个视图的所有数据，带条件，排序
			/// TSQL 格式： SELECT * FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp} ORDER BY {sd}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			...
			/// <summary>
			/// 返回一个视图的所有数据，带条件，排序，限定行数
			/// TSQL 格式： SELECT TOP top * FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp} ORDER BY {sd}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
...
");
			...
			/// <summary>
			/// 返回一个表的所有数据的部分字段 带排序
			/// TSQL 格式： SELECT __cols..... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] ORDER BY {sd}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			...
			/// <summary>
			/// 返回一个表的所有数据的部分字段 带排序，限定行数
			/// TSQL 格式： SELECT TOP top __cols..... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] ORDER BY {sd}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
...
");
			...
			/// TSQL 格式： SELECT __cols... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {where}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			...
			/// <summary>
			/// 返回一个表的所有数据的部分字段，带条件
			/// TSQL 格式： SELECT __cols... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			...
			/// <summary>
			/// 返回一个表的所有数据的部分字段，带条件，排序
			/// TSQL 格式： SELECT __cols... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp} ORDER BY {sd}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			...
			/// <summary>
			/// 返回一个表的所有数据的部分字段，带条件，排序，行数限定
			/// TSQL 格式： SELECT TOP top __cols... FROM [" + Utils.GetEscapeSqlObjectName(v.Schema) + @"].[" + Utils.GetEscapeSqlObjectName(v.Name) + @"] WHERE {exp} ORDER BY {sd}
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
...
");
			...
			/// <summary>
			/// 根据传入的外键s，查找返回一个表的所有数据的部分字段，带额外条件，排序，限定行数
			/// </summary>
			[System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select)]
			public static DataTable SelectAllPart_By_" + s + @"(");
							for (int i = 0; i < fk.Columns.Count; i++)

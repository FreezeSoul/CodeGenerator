...
{
    public class Gen_View_SelectAll : IGenComponent
    {
        #region Init

        public Gen_View_SelectAll()
        {
            this._properties.Add(GenProperties.Name, "Gen_View_SelectAll");
            this._properties.Add(GenProperties.Caption, "查询所有");
            this._properties.Add(GenProperties.Group, "生成过程脚本_SELECT类");
            this._properties.Add(GenProperties.Tips, "生成查询视图所有数据的存储过程脚本");
        }

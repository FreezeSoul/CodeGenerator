...
{
    public class Gen_Table_SelectAll_Page_Custom : IGenComponent
    {
        #region Init

        public Gen_Table_SelectAll_Page_Custom()
        {
            this._properties.Add(GenProperties.Name, "Gen_Table_SelectAll_Page_Custom");
            this._properties.Add(GenProperties.Caption, "查询所有(翻页,条件)");
            this._properties.Add(GenProperties.Group, "生成过程脚本_SELECT类");
            this._properties.Add(GenProperties.Tips, "生成查询表所有数据(翻页,条件)的存储过程脚本");
        }

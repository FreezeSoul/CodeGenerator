...
{
    public class Gen_Table_SelectNodeWhile : IGenComponent
    {
        #region Init

        public Gen_Table_SelectNodeWhile()
        {
            this._properties.Add(GenProperties.Name, "Gen_Table_SelectNodeWhile");
            this._properties.Add(GenProperties.Caption, "查询节点（WHILE版）");

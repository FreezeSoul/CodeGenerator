...
{
    public class Gen_View_SelectAll_Page_Blur : IGenComponent
    {
        #region Init

        public Gen_View_SelectAll_Page_Blur()
        {
            this._properties.Add(GenProperties.Name, "Gen_View_SelectAll_Page_Blur");
            this._properties.Add(GenProperties.Caption, "查询所有(翻页,模糊查询)");
            this._properties.Add(GenProperties.Group, "生成过程脚本_SELECT类");
            this._properties.Add(GenProperties.Tips, "生成查询视图所有数据(翻页,模糊查询)的存储过程脚本");
        }

...
{
    public class Gen_Table_SelectAll_Blur : IGenComponent
    {
        #region Init

        public Gen_Table_SelectAll_Blur()
        {
            this._properties.Add(GenProperties.Name, "Gen_Table_SelectAll_Blur");
            this._properties.Add(GenProperties.Caption, "查询所有(带模糊查询)");
            this._properties.Add(GenProperties.Group, "生成过程脚本_SELECT类");
            this._properties.Add(GenProperties.Tips, "生成查询表所有数据带模糊查询条件的存储过程脚本");
        }

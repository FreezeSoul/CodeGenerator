...
{
    public class Gen_View_SelectAll_Custom : IGenComponent
    {
        #region Init

        public Gen_View_SelectAll_Custom()
        {
            this._properties.Add(GenProperties.Name, "Gen_View_SelectAll_Custom");
            this._properties.Add(GenProperties.Caption, "查询所有(带条件)");
            this._properties.Add(GenProperties.Group, "生成过程脚本_SELECT类");
            this._properties.Add(GenProperties.Tips, "生成查询视图所有数据带条件的存储过程脚本");
        }

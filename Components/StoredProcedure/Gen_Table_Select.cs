...
{
    public class Gen_Table_Select : IGenComponent
    {
        #region Init

        public Gen_Table_Select()
        {
            this._properties.Add(GenProperties.Name, "Gen_Table_Select");
            this._properties.Add(GenProperties.Caption, "查询单条");
            this._properties.Add(GenProperties.Group, "生成过程脚本_SELECT类");
            this._properties.Add(GenProperties.Tips, "生成根据表的主键查询表单条数据的存储过程脚本");
        }

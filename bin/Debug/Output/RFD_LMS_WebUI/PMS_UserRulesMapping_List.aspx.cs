...
{
    public partial class PMS_UserRulesMapping_List : PageBase
    {
        ...
        {
            //实例化业务层
            var server = ServiceLocator.GetService<IPMS_UserRulesMappingService>();
            var model = new PMS_UserRulesMapping();
